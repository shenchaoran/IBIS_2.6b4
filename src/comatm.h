...
c
c     common /comatm2/ solad, solai, asurd, asuri
c
      real 
...
c
c     common /comatm3/ ua, ta, qa, raina, rh, snowa
c
      real 
     ...
     >  precipdaysum(npoi)       
c
c     common /comatm4/ psurf, cloud, td, tmax, tmin, qd, ud, precip,
     >                   precipday, precipdaysum
c
      real 
     >  xstore(npoi,3)     ! weather generator 'memory' matrix
c
c     common /comatm5/ xstore
c
      integer 
     ...
     >  iwetdaysum(npoi) 
c
c     common /comatm6/ iwet, iwetday, iwetdaysum
c
      real 
     >  co2conc,           ! co2 concentration (mol/mol)
     >  o2conc             ! o2 concentration (mol/mol)
c
c     common /comatm7/ co2conc, o2conc
c
